...
export class GroupsController {
    constructor(private groupService: GroupsService, private groupRepository: GroupsRepository) {}
    ...
    @ApiResponse({ status: 200, type: [Group] })
    @Post('/add-users/:guid')
    async addTo(@Param('guid') guid: string, @Body() usersToGroupDto: UsersToGroupDto) {
        return this.groupService
    ...
    async unsetFrom(@Param('guid') guid: string, @Body() usersToGroupDto: UsersToGroupDto) {
        return this.groupService
